...
class Contact extends BaseModel
{
    ...
    const TYPE_CHECKOUT_RESOURCE = 'RESOURCE';
    const TYPE_CHECKOUT_COURSE = 'COURSE';
    ...
    public const TYPE_LIST = [
        ...
        self::TYPE_CHECKOUT_RESOURCE => 'Thanh toán Tài Nguyên',
        self::TYPE_CHECKOUT_COURSE => 'Thanh toán khóa học',
    ...
    public function getFormattedTypeAttribute(): string
    {
        switch ($this->type) {
            case 'CONTACT_FORM':
                return 'Liên hệ';
            case 'TYPE_CHECKOUT_RESOURCE':
                return 'Tài nguyên';
            case 'TYPE_CHECKOUT_COURSE':
                return 'Khóa học';
            default:
                return '';
        }
