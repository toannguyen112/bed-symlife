        ...
        <section class="pt-[84px] md:pt-[100px] lg:pt-[120px] xl:pt-[160px] pb-10 md:pb-14 xl:pb-20">
            <div class="container">
                <div class="grid grid-cols-12 gap-y-4 md:gap-y-6 xl:gap-y-8 md:gap-x-6 xl:gap-x-10">
                    ...
                    >
                        <h1 class="display-3 font-bold font-display text-black-fks">Nhật kí thi công</h1>
                        <div class="body-1 text-black-fks font-beau">Hình ảnh các dự án đã làm</div>
                    </div>
                    <div class="col-span-full grid grid-cols-4 md:gap-[24px] gap-[12px]">
                        <div v-for="(item, index) in images" :key="index" class="col-span-2 md:col-span-1">
